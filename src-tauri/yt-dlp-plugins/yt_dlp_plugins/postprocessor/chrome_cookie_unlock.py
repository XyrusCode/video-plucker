...
#
# Deviation from upstream: the Restart Manager (Rstrtmgr.dll) code is Windows
# only, so the ctypes import and the unlock helper are gated on win32. Without
# the gate, importing the module on macOS/Linux aborts after the monkey patch
# above, leaving unlock_chrome pointing at an undefined helper.
